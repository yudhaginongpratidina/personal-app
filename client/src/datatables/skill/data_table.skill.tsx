...
export default function DataTableSkill<TData extends { id: number | string }, TValue>({ columns, data }: TableProps<TData, TValue>) {
        ...
        <>
            <div className="w-full flex items-center justify-between gap-2 py-1.5">
                ...
                <div className="w-full flex items-center gap-2">
                    ...
                    />
                    <Link to="/admin/skill/create" className="w-fit py-1.5 px-4 bg-black hover:bg-gray-800 duration-100 text-white rounded-md">create</Link>
                </div>
            </div>
            <Table>
                <TableHeader>
