...
import { levelLearningPathFormSchema, LevelLearningPathFormSchema } from "@/validators/level_learning_path.validator";

export default function CreateLevelLearningPathView() {

    const { register, handleSubmit, formState: { errors } } = useForm<LevelLearningPathFormSchema>({
        resolver: zodResolver(levelLearningPathFormSchema)
    })

    const onSubmit = async (data: LevelLearningPathFormSchema) => {
        console.log(data)
    }
        ...
        <div className="w-full min-h-screen flex justify-center items-center container">
            <div className="w-full max-w-md flex flex-col gap-4">
                <div className="w-full">
                    <h1 className="text-2xl font-semibold uppercase">Create Level Learning Path</h1>
